...
<div class="container">
    ...
    <h1 class="form__title">Welcome <?php  echo $_SESSION['user_name'];?>  </h1>
    
                <h1 class="form__title">Enter your Subjects</h1>
                <div class="form__message form__message--error"></div>
                <div class="form__input-group">
                    <input type="text"  name="subj1" class="form__input" autofocus placeholder="Subject1" autocomplete="off"  onfocus="this.value=''" >
                    <div class="form__input-error-message"></div>
                </div>
                <div class="form__input-group">
                    <input type="text"  name="subj2" class="form__input" autofocus placeholder="Subject2" autocomplete="off"  onfocus="this.value=''">
                    <div class="form__input-error-message"></div>
                </div>
                <div class="form__input-group">
                    <input type="text" class="form__input" name="subj3"  autofocus placeholder="Subject3" autocomplete="off"  onfocus="this.value=''">
                    <div class="form__input-error-message"></div>
                </div>
                <div class="form__input-group">
                    <input type="text" class="form__input" name="subj4" autofocus placeholder="Subject4" autocomplete="off"  onfocus="this.value=''">
                    <div class="form__input-error-message"></div>
                </div>
                <button class="form__button1" type="submit" name="add">ADD</button>
